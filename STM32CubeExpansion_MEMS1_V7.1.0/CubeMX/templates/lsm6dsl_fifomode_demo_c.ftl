...
/**
  ...
  * @retval None
  */
void MX_LSM6DSL_FIFOMode_Init(void)
{
  /* Initialize LED */
  BSP_LED_Init(LED2);
...
/**
  ...
  * @retval None
  */
void MX_LSM6DSL_FIFOMode_Process(void)
{
...
static int32_t LSM6DSL_FIFO_Set_FIFO_Mode(void)
{
  ...
  if ((ret = CUSTOM_MOTION_SENSOR_FIFO_Set_Mode(CUSTOM_LSM6DSL_0, (uint8_t)LSM6DSL_FIFO_MODE)) != BSP_ERROR_NONE)
  {
    return ret;
  }
