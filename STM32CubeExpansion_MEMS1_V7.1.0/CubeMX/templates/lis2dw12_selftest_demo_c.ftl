...
/**
  ...
  * @retval None
  */
void MX_LIS2DW12_SelfTest_Init(void)
{
  /* Initialize LED */
  BSP_LED_Init(LED2);
...
/**
  ...
  * @retval None
  */
void MX_LIS2DW12_SelfTest_Process(void)
{
...
static int32_t LIS2DW12_X_SelfTest(void)
{
  ...
  {
    if ((ret = CUSTOM_MOTION_SENSOR_Read_Register(CUSTOM_LIS2DW12_0, reg_addr[i], &prev_reg_values[i])) != BSP_ERROR_NONE)
    {
      return ret;
    }
  }
  ...
  for (i = 0; i < ST_REG_COUNT; i++)
  {
    if ((ret = CUSTOM_MOTION_SENSOR_Write_Register(CUSTOM_LIS2DW12_0, reg_addr[i], x_st_reg_values[i])) != BSP_ERROR_NONE)
    {
      return ret;
    }
  }
  ...
  /* Enable self-test */
  if ((ret = CUSTOM_MOTION_SENSOR_Set_SelfTest(CUSTOM_LIS2DW12_0, MOTION_ACCELERO, (uint8_t)LIS2DW12_ST_POSITIVE)) != BSP_ERROR_NONE)
  {
    return ret;
  }
  ...
  for (i = 0; i < ST_REG_COUNT; i++)
  {
    if ((ret = CUSTOM_MOTION_SENSOR_Write_Register(CUSTOM_LIS2DW12_0, reg_addr[i], prev_reg_values[i])) != BSP_ERROR_NONE)
    {
      return ret;
    }
  }
...
/**
  ...
  * @retval None
  */
static int32_t LIS2DW12_X_Get_Data(CUSTOM_MOTION_SENSOR_Axes_t *data)
{
  uint8_t status;
  int32_t ret;
  ...
  do
  {
    if ((ret = CUSTOM_MOTION_SENSOR_Get_DRDY_Status(CUSTOM_LIS2DW12_0, MOTION_ACCELERO, &status)) != BSP_ERROR_NONE)
    {
      return ret;
    }
  }
  ...
  /* Read accelero data */
  if ((ret = CUSTOM_MOTION_SENSOR_GetAxes(CUSTOM_LIS2DW12_0, MOTION_ACCELERO, data)) != BSP_ERROR_NONE)
  {
    return ret;
  }
