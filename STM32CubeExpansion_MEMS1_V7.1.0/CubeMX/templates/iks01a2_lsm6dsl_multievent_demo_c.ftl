...
[#if LSM6DSL_EVENT1_value == "INT2"][#-- ####################################### --]
        || (IKS01A2_MOTION_SENSOR_Enable_Tilt_Detection(IKS01A2_LSM6DSL_0, IKS01A2_MOTION_SENSOR_INT2_PIN) != BSP_ERROR_NONE)
        || (IKS01A2_MOTION_SENSOR_Enable_Free_Fall_Detection(IKS01A2_LSM6DSL_0, IKS01A2_MOTION_SENSOR_INT2_PIN) != BSP_ERROR_NONE)
        || (IKS01A2_MOTION_SENSOR_Enable_Single_Tap_Detection(IKS01A2_LSM6DSL_0, IKS01A2_MOTION_SENSOR_INT2_PIN) != BSP_ERROR_NONE)
        || (IKS01A2_MOTION_SENSOR_Enable_Double_Tap_Detection(IKS01A2_LSM6DSL_0, IKS01A2_MOTION_SENSOR_INT2_PIN) != BSP_ERROR_NONE)
        || (IKS01A2_MOTION_SENSOR_Enable_6D_Orientation(IKS01A2_LSM6DSL_0, IKS01A2_MOTION_SENSOR_INT2_PIN) != BSP_ERROR_NONE)
[/#if][#-- ################################################################# --]
[#if LSM6DSL_EVENT2_value == "INT1"][#-- ####################################### --]
        || (IKS01A2_MOTION_SENSOR_Enable_Wake_Up_Detection(IKS01A2_LSM6DSL_0, IKS01A2_MOTION_SENSOR_INT1_PIN) != BSP_ERROR_NONE)
[/#if][#-- ################################################################# --]
