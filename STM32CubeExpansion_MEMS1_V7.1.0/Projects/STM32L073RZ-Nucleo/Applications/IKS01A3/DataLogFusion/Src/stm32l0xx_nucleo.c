...
/** @defgroup STM32L0XX_NUCLEO STM32L0XX_NUCLEO
 * @{
 */   
    
/** @defgroup STM32L0XX_NUCLEO_LOW_LEVEL STM32L0XX_NUCLEO LOW LEVEL
...
/** @defgroup STM32L0XX_NUCLEO_LOW_LEVEL_Private_Defines STM32L0XX_NUCLEO LOW LEVEL Private Defines
 * @{
 */ 

/** @defgroup STM32L0XX_NUCLEO_LOW_LEVEL_FunctionPrototypes STM32L0XX_NUCLEO LOW LEVEL Private Function Prototypes
 * @{
 */
...
/** @defgroup STM32L0XX_NUCLEO_LOW_LEVEL_Private_Variables STM32L0XX_NUCLEO LOW LEVEL Private Variables
 * @{
 */
...
{
  return (int32_t)__STM32L0XX_NUCLEO_BSP_VERSION;
}
