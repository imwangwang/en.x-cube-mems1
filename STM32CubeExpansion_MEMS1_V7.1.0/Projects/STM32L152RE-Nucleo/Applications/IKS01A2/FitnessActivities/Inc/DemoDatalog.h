...
/* Data structure must be allighed to multiple of 64bits, because the flash memory
in L476RG is organized as 72-bit wide memory cells (64 bits plus 8 ECC bits) */
typedef struct
{
  DateTime_t date_time;
  uint16_t activity_counter; /* 0 if new session */
