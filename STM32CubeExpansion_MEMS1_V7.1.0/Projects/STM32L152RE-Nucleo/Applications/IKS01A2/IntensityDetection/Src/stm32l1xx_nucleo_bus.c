...
/** @defgroup STM32L1XX_NUCLEO_BUS_Exported_Variables BUS Exported Variables
  * @{
  */
...
/** @defgroup STM32L1XX_NUCLEO_BUS_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup STM32L1XX_NUCLEO_BUS_Private_FunctionPrototypes  BUS Private Function
  * @{
  */  
...
/** @defgroup STM32L1XX_NUCLEO_BUS_Exported_Functions STM32L1XX_NUCLEO_BUS Exported Functions
  * @{
  */   
