...
{
  char fw_id[] = {"6"}; /* FW ID for Unicleo-GUI */
  ...
  MotionAC_manager_get_version(lib_version_string, &lib_version_len);
...
/* Private functions ---------------------------------------------------------*/
/**
  * @brief  Initialize the AccelerometerCalibration application
  * @retval None
  */
static void MX_AccelerometerCalibration_Init(void)
{
...
/**
  * @brief  Process of the AccelerometerCalibration application
  * @retval None
  */
static void MX_AccelerometerCalibration_Process(void)
{
...
/**
 * @brief  AccelerometerCalibration data handler
 * @param  Msg the AccelerometerCalibration data part of the stream
 * @retval None
 */
static void AC_Data_Handler(TMsg *Msg)
{
  ...
  if ((SensorsEnabled & ACCELEROMETER_SENSOR) == ACCELEROMETER_SENSOR)
  {
    ...
    /* Run AccelerometerCalibration algorithm */
    BSP_LED_On(LED2);
    DWT_Start();
