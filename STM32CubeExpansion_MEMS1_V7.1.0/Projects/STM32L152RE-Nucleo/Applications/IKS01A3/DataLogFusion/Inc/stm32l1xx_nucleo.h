...
/* Includes ------------------------------------------------------------------*/ 
#include "stm32l1xx_nucleo_conf.h"
...
/** @defgroup STM32L4XX_NUCLEO_LOW_LEVEL_Exported_Constants LOW LEVEL Exported Constants
  ...
  */
/**
 * @brief STM32L1XX NUCLEO BSP Driver version number V1.0.0
 */  
...
/** @defgroup STM32L1XX_NUCLEO_LOW_LEVEL_Exported_Types STM32L1XX_NUCLEO LOW LEVEL Exported Types
 * @{
 */
...
/** @defgroup STM32L1XX_NUCLEO_LOW_LEVEL_LED STM32L1XX_NUCLEO LOW LEVEL LED
 * @{
 */  
#define LEDn                              1U
...
/** @defgroup STM32L1XX_NUCLEO_LOW_LEVEL_BUTTON STM32L1XX_NUCLEO LOW LEVEL BUTTON
 * @{
 */ 
/* Button state */
...
/** @defgroup STM32L1XX_NUCLEO_LOW_LEVEL_COM STM32L1XX_NUCLEO LOW LEVEL COM
 * @{
 */
/**
...
/** @defgroup STM32L1XX_NUCLEO_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Constants
  * @{
  */   
...
/** @defgroup STM32L1XX_NUCLEO_LOW_LEVEL_Exported_Functions STM32L1XX_NUCLEO LOW LEVEL Exported Functions
 * @{
 */ 
