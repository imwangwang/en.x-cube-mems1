...
static void MX_IKS01A2_LSM6DSL_Tilt_Init(void);
static void MX_IKS01A2_LSM6DSL_Tilt_Process(void);
...
/**
  ...
  * @retval None
  */
void MX_IKS01A2_LSM6DSL_Tilt_Init(void)
{
  /* Initialize LED */
  BSP_LED_Init(LED2);
...
/**
  ...
  * @retval None
  */
void MX_IKS01A2_LSM6DSL_Tilt_Process(void)
{
