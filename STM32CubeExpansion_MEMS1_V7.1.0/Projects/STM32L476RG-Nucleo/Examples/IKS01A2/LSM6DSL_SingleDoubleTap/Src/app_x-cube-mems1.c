...
static void MX_IKS01A2_LSM6DSL_SingleDoubleTap_Init(void);
static void MX_IKS01A2_LSM6DSL_SingleDoubleTap_Process(void);
...
void MX_MEMS_Init(void)
{
  ...
  MX_IKS01A2_LSM6DSL_SingleDoubleTap_Init();
