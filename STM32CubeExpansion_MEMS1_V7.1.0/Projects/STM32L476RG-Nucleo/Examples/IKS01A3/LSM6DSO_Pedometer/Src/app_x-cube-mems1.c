...
static void MX_IKS01A3_LSM6DSO_Pedometer_Init(void);
static void MX_IKS01A3_LSM6DSO_Pedometer_Process(void);
...
/**
  ...
  * @retval None
  */
void MX_IKS01A3_LSM6DSO_Pedometer_Init(void)
{
  /* Initialize LED */
  BSP_LED_Init(LED2);
  ...
  /* Enable pedometer */
  (void)IKS01A3_MOTION_SENSOR_Enable_Pedometer(IKS01A3_LSM6DSO_0);
...
/**
  ...
  * @retval None
  */
void MX_IKS01A3_LSM6DSO_Pedometer_Process(void)
{
  ...
  if (StepCountResetRequest != 0U)
  {
    ...
    if (IKS01A3_MOTION_SENSOR_Reset_Step_Counter(IKS01A3_LSM6DSO_0) != BSP_ERROR_NONE)
    {
      Error_Handler();
    }
  }
...
static void Send_Step_Count(void)
{
  if (IKS01A3_MOTION_SENSOR_Get_Step_Count(IKS01A3_LSM6DSO_0, &StepCount) != BSP_ERROR_NONE)
  {
