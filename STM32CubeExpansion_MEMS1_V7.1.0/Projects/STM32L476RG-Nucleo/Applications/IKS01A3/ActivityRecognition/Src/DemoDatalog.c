...
#define FLASH_LESSTHAN2HH            ((uint32_t)0x0800FA5F)
...
#error Not supported platform
    ...
    {
#if ((defined (USE_STM32F4XX_NUCLEO)) || (defined (USE_STM32L0XX_NUCLEO)) || (defined (USE_STM32L1XX_NUCLEO)))
      for (nword = 0; nword < (sizeof(DataByte_t) / 4U); nword++)
      {
...
#elif ((defined (USE_STM32L0XX_NUCLEO)) || (defined (USE_STM32L1XX_NUCLEO)))
