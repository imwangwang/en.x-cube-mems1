...
IKS02A1_MOTION_SENSOR_Axes_t AccValue;     /* Raw accelerometer data [mg] */
IKS02A1_MOTION_SENSOR_Axes_t MagValue;     /* Raw magnetometer data [mGauss] */
IKS02A1_MOTION_SENSOR_Axes_t MagValueComp; /* Compensated magnetometer data [mGauss] */
...
static void Init_Sensors(void)
{
   ...
   *   - FS   = <-2g, 2g>
   */
  (void)IKS02A1_MOTION_SENSOR_SetOutputDataRate(IKS02A1_ISM330DHCX_0, MOTION_ACCELERO, 100.0f);
  (void)IKS02A1_MOTION_SENSOR_SetFullScale(IKS02A1_ISM330DHCX_0, MOTION_ACCELERO, 2);

  /* Set magnetometer:
   *   - ODR >= 100Hz
   *   - FS   = 50Gauss (always)
   */
  (void)IKS02A1_MOTION_SENSOR_SetOutputDataRate(IKS02A1_IIS2MDC_0, MOTION_MAGNETO, 100.0f);
}
