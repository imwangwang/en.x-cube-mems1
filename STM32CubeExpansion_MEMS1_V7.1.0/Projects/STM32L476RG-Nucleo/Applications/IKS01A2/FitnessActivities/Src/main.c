...
static void Init_Sensors(void)
{
   ...
   *   - ODR >= 25 Hz
   */
  (void)IKS01A2_MOTION_SENSOR_SetOutputDataRate(IKS01A2_LSM6DSL_0, MOTION_ACCELERO, 25.0f);

  /* Set gyroscope:
   *   - ODR >= 25 Hz
   */
  (void)IKS01A2_MOTION_SENSOR_SetOutputDataRate(IKS01A2_LSM6DSL_0, MOTION_GYRO, 25.0f);

  /* Set pressure sensor:
   *   - ODR >= 25 Hz
   */
  (void)IKS01A2_ENV_SENSOR_SetOutputDataRate(IKS01A2_LPS22HB_0, ENV_PRESSURE, 25.0f);
}
