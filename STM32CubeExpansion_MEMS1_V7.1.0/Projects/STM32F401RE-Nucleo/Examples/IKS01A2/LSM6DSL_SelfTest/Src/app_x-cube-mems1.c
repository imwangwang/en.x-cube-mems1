...
static int32_t LSM6DSL_X_Get_Data(IKS01A2_MOTION_SENSOR_Axes_t *data);
static int32_t LSM6DSL_G_Get_Data(IKS01A2_MOTION_SENSOR_Axes_t *data);
...
void MX_MEMS_Init(void)
{
  ...
  MX_IKS01A2_LSM6DSL_SelfTest_Init();
...
/**
  ...
  * @retval None
  */
void MX_IKS01A2_LSM6DSL_SelfTest_Process(void)
{
...
static int32_t LSM6DSL_X_SelfTest(void)
{
  ...
  uint32_t i;
  IKS01A2_MOTION_SENSOR_Axes_t data_nost;
  IKS01A2_MOTION_SENSOR_Axes_t data_st;
  ...
  {
    if ((ret = IKS01A2_MOTION_SENSOR_Read_Register(IKS01A2_LSM6DSL_0, reg_addr[i], &prev_reg_values[i])) != BSP_ERROR_NONE)
    {
      return ret;
    }
  }
  ...
  for (i = 0; i < ST_REG_COUNT; i++)
  {
    if ((ret = IKS01A2_MOTION_SENSOR_Write_Register(IKS01A2_LSM6DSL_0, reg_addr[i], x_st_reg_values[i])) != BSP_ERROR_NONE)
    {
      return ret;
    }
  }
  ...
  /* Enable self-test */
  if ((ret = IKS01A2_MOTION_SENSOR_Set_SelfTest(IKS01A2_LSM6DSL_0, MOTION_ACCELERO, (uint8_t)LSM6DSL_XL_ST_POSITIVE)) != BSP_ERROR_NONE)
  {
    return ret;
  }
  ...
  for (i = 0; i < ST_REG_COUNT; i++)
  {
    if ((ret = IKS01A2_MOTION_SENSOR_Write_Register(IKS01A2_LSM6DSL_0, reg_addr[i], prev_reg_values[i])) != BSP_ERROR_NONE)
    {
      return ret;
    }
  }
...
static int32_t LSM6DSL_G_SelfTest(void)
{
  ...
  for (i = 0; i < ST_REG_COUNT; i++)
  {
    if ((ret = IKS01A2_MOTION_SENSOR_Write_Register(IKS01A2_LSM6DSL_0, reg_addr[i], g_st_reg_values[i])) != BSP_ERROR_NONE)
    {
      return ret;
    }
  }
  ...
  /* Enable self-test */
  if ((ret = IKS01A2_MOTION_SENSOR_Set_SelfTest(IKS01A2_LSM6DSL_0, MOTION_GYRO, (uint8_t)LSM6DSL_GY_ST_POSITIVE)) != BSP_ERROR_NONE)
  {
    return ret;
  }
...
static int32_t LSM6DSL_X_Get_Data(IKS01A2_MOTION_SENSOR_Axes_t *data)
{
  ...
  do
  {
    if ((ret = IKS01A2_MOTION_SENSOR_Get_DRDY_Status(IKS01A2_LSM6DSL_0, MOTION_ACCELERO, &status)) != BSP_ERROR_NONE)
    {
      return ret;
    }
  }
  ...
  /* Read accelero data */
  if ((ret = IKS01A2_MOTION_SENSOR_GetAxes(IKS01A2_LSM6DSL_0, MOTION_ACCELERO, data)) != BSP_ERROR_NONE)
  {
    return ret;
  }
...
static int32_t LSM6DSL_G_Get_Data(IKS01A2_MOTION_SENSOR_Axes_t *data)
{
  ...
  do
  {
    if ((ret = IKS01A2_MOTION_SENSOR_Get_DRDY_Status(IKS01A2_LSM6DSL_0, MOTION_GYRO, &status)) != BSP_ERROR_NONE)
    {
      return ret;
    }
  }
  ...
  /* Read accelero data */
  if ((ret = IKS01A2_MOTION_SENSOR_GetAxes(IKS01A2_LSM6DSL_0, MOTION_GYRO, data)) != BSP_ERROR_NONE)
  {
    return ret;
  }
