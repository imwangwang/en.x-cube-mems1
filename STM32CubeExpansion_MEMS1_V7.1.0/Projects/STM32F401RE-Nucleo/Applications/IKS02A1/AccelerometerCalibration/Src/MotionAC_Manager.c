 ...
 * @brief   This file contains Accelerometer Calibration interface functions
 ******************************************************************************
 * @attention
 *
 ...
 * @retval none
 */
void MotionAC_manager_compensate(IKS02A1_MOTION_SENSOR_Axes_t *data_in, IKS02A1_MOTION_SENSOR_Axes_t *data_out)
{
